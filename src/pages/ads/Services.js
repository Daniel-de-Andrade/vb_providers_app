  ...
  return (
    <>
      <div className="p-4 py-5">
        ...
        <p
          ng-show="openedAds.services.length == 0"
      ...
      <div
        ...
        tabIndex="-1"
        aria-labelledby="addServicesModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="addServicesModalLabel">
                Adicionar serviço
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              <form
                name="addServiceForm"
                className=""
                ng-submit="create(addServiceData)"
              >
                <div className="mb-3">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      name="title"
                      ng-model="addServiceData.title"
                      ng-required="true"
                    />
                  </div>

                  <div className="mb-3">
                    <label className="perfilLabel">Categoria</label>
                    <select
                      className="rounded-pill form-select"
                      name="category"
                      ng-model="addServiceData.category"
                    >
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form
                ...
                className=""
                ng-submit="update(openedService)"
              >
                <div className="mb-3">
                  <div className="mb-3">
                    <label htmlFor="address" className="form-label">
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      className="rounded-pill form-select"
                      name="category"
                      ng-model="openedService.category"
                    >
                      <option value="">Selecione</option>
                      <option value="hair">Cabelo</option>
                      <option value="nails">Unhas</option>
