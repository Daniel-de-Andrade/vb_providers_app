...
<div id="homePic" class="text-center my-auto mb-4">
    <img src="/assets/img/blank.png" class="rounded-circle w-100 border-5 border-purple border" alt="" style="background-image: url(data:image/png;base64,{{vbData.userdata.photo}}); background-position:center; background-size:cover;">
</div>
<div class="p-4">
    ...
    <p>
        <a href="/agenda/requests" class="btn btn-primary w-100 btn-primary rounded-pill">
    ...
    <div class="mb-4">
        ...
        <p class="text-center text-muted bg-light p-3" ng-show="vbData.homeEvents.length == 0">
            Você não tem nenhum próximo compromisso.
        </p>

        <!-- Event card -->
        <a href="/agenda/details" class="text-decoration-none mb-4 d-block" ng-repeat="event in vbData.homeEvents" ng-click="openEvent(event)" ng-show="vbData.homeEvents.length > 0">
